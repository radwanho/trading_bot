...
class Binance(Exchange):
    ...
    def order_fills_details(self, order, count, close, balance):
        orderFillsDetails = []
        for o in order["fills"]:
            orderFillsDetails.append({"count": count, "side": order["side"], "close": close, "price": order["cummulativeQuoteQty"], "t_qty": o["qty"], "t_commission": self.calc_commission_of_order(o), "balance": balance})
